...
EventListener::listen('message', function($msg) {
    ...
    if (($cmd === '.voice' || $cmd === '.v') && $msg['from_id'] === Api::$user_id) {
        if (!isset($args[0])) {
            Api::editMessage('Введите число от 1 до 25 для выбора музыки.', $msg);
            return;
        }
        ...
        try {
            ...
            Api::editMessage('Музыка не найдена! Введите число от 1 до 25.', $msg);
            return;
        }
    ...
    if ($cmd === '.tagall' && $msg['from_id'] === Api::$user_id) {
        ...
        Api::editMessage($tag_message, $msg);
    }
    ...
    if ($poops->exists($msg['from_id']) && $msg['from_id'] !== Api::$user_id) {
    ...
    if ($bulling->exists($msg['from_id']) && $msg['from_id'] !== Api::$user_id) {
